...
SCHEMA_MODELS: Mapping[str, type[BaseModel]] = {
    ...
    "document-layout-policy": DocumentLayoutPolicy,
    "document-site-manifest": DocumentSiteManifest,
    "impact-decision": ImpactDecision,
    "experiment-plan": ExperimentPlan,
    "github-governance-policy": GitHubGovernancePolicy,
    "linear-projection-policy": LinearProjectionPolicy,
    "markdown-frontmatter": MarkdownFrontmatter,
